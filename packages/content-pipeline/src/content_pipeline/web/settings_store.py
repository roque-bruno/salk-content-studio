...
API_KEY_DEFINITIONS = [
    {
        ...
        "group": "geracao",
        "description": "Chave para geração de imagens via Gemini",
        "required": False,
        "placeholder": "AIza...",
    },
    {
        ...
        "group": "llm",
        "description": "Roteamento de LLMs (briefing, copy, compliance)",
        "required": False,
    ...
    },
    {
        ...
        "group": "video",
        "description": "Projeto GCP para Veo 3 via Vertex AI (opcional — sem ele usa Gemini API)",
        "required": False,
    ...
    },
    {
        ...
        "group": "video",
        "description": "Text-to-Speech para narração de vídeos",
        "required": False,
        "placeholder": "xi-...",
    },
    {
...
# Agrupamento para UI
SETTINGS_GROUPS = {
    "geracao": {"label": "Geração de Imagem", "icon": "🎨"},
    "llm": {"label": "LLM / IA", "icon": "🧠"},
    "video": {"label": "Video Pipeline", "icon": "🎬"},
    "publishers": {"label": "Publicação", "icon": "📢"},
